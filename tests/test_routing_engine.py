...
def test_case_a_low_complexity_no_risk_routes_to_luna():
    """Case A: 2 files, no risk flags -> LOW complexity -> GPT-5.6 Luna."""
...
def test_case_b_medium_complexity_routes_to_terra():
    """Case B: file count + ordinary flags reach MEDIUM complexity -> GPT-5.6 Terra."""
...
def test_case_c_low_complexity_but_authorization_forces_terra():
    """Case C: 2 files + authorization=true -> hard risk forces Terra despite LOW complexity."""
...
def test_case_d_concurrency_and_idempotency_force_terra():
    """Case D: concurrency + idempotency hard-risk flags force Terra."""
...
def test_case_e_architecture_change_during_planning_routes_to_opus():
    """Case E: architecture_change=true during planning -> Claude Opus 5."""
...
def test_high_complexity_implementation_without_hard_risk_still_routes_to_terra():
    """HIGH complexity reached via non-hard-risk flags routes to Terra through the project rule."""
